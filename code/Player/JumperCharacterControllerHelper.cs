...
internal struct JumperCharacterControllerHelper
{
	//
	// Inputs and Outputs
	//
	...
	public JumperCharacterControllerHelper( PhysicsTraceBuilder trace, Vector3 position, Vector3 velocity ) : this()
	{
		Velocity = velocity;
		Position = position;
		Bounce = 0.0f;
...
file struct VelocityClipPlanes : IDisposable
{
	...
	/// </summary>
	public Vector3 ClipVelocity( Vector3 vel, Vector3 norm, float overbounce = 1.0f )
	{
