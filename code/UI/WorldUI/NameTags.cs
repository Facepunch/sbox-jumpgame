...
internal class NameTagComponent : EntityComponent<JumperPawn>
{
	NameTag NameTag;
	...
	{
		foreach ( var player in Sandbox.Entity.All.OfType<JumperPawn>() )
		{
...
public class NameTag : WorldPanel
{
	...
	{
		StyleSheet.Load( "/ui/WorldUI/NameTags.scss" );
